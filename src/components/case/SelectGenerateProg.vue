<template>
  <div class="SelectGenerateProg">
    <el-form id="search" style="width: 400px; height: 100px; margin: 20px auto">
      <el-select v-model="project" placeholder="请选择所属项目" style="margin-right: 10px">
        <el-option
  ...
  setup() {
    ...
    const search = async () => {
      ...
      for (let i = 0; i < data.length; i++) {
        Progs[i]=data[i].name;
        similaritys[i]=Math.round(data[i].similarity*100);
      }
